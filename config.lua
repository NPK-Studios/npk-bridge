...
Config.Language = 'en' -- [en, pl, fr, de, es, it, tr, ru, sv]
-- open ticket on our discord if you want to add your language [discord.gg/npkstudios]
...
--[[
    ...
    -- open ticket on our discord if you want to add your framework [discord.gg/npkstudios]
]]
...
--[[
    ...
    -- open ticket on our discord if you want to add your target system [discord.gg/npkstudios]
]]
...
--[[
    ...
    -- open ticket on our discord if you want to add your inventory system [discord.gg/npkstudios]
]]
...
--[[
    ...
    -- open ticket on our discord if you want to add your notification system [discord.gg/npkstudios]
]]
...
--[[
    ...
    -- open ticket on our discord if you want to add your appearance system [discord.gg/npkstudios]
]]
...
--[[
    ...
    -- open ticket on our discord if you want to add your car keys system [discord.gg/npkstudios]
]]
...
--[[
    ...
    -- open ticket on our discord if you want to add your dispatch system [discord.gg/npkstudios]
]]
...
--[[
    ...
    -- open ticket on our discord if you want to add your progress bar system [discord.gg/npkstudios]
]]
...
--[[
    ...
    -- open ticket on our discord if you want to add your society system [discord.gg/npkstudios]
]]
...
--[[
    ...
    -- open ticket on our discord if you want to add your boss menu system [discord.gg/npkstudios]
]]
...
--[[
    ...
    -- open ticket on our discord if you want to add your fuel system [discord.gg/npkstudios]
]]

--@param Config.Banking: string [set which banking system you are using]
Config.Banking = 'auto'
--[[
    auto - will try to detect banking system automatically
    npk-banking - NPKStudios Banking [recommended]
    standalone - no banking resource; Bridge.Banking works directly on the
                 `transactions_history` / `bank_invoices` / `bank_accounts` tables
]]

--@param Config.Radial: string [set which radial menu you are using]
Config.Radial = 'auto'
--[[
    auto - will try to detect radial menu automatically
    ox_lib - ox_lib radial menu [recommended]
]]
...
--[[
    ...
    -- open ticket on our discord if you want to add your TextUI system [discord.gg/npkstudios]
]]
...
RegisterNetEvent('esx:playerLoaded', function(xPlayer) 
    ...
    TriggerEvent('npk-bridge/client/setPlayerData', ESX.PlayerData)
end)
...
Bridge.Framework.getIdentifier = function()
    ...
    if not identifier then
        Bridge.libs.print.error('ESX PlayerData not loaded yet. Please wait for the playerLoaded event.')
        return nil
    end

if (Config.Appearance == 'auto' and not checkResource('p_appearance')) or (Config.Appearance ~= 'auto' and Config.Appearance ~= 'p_appearance') then
    return
end
...
if Config.Debug then
    Bridge.libs.print.info('[Appearance] Loaded: p_appearance')
end

...
if Config.Debug then
    Bridge.libs.print.info('[Inventory] Loaded: S-Inventory')
end
...
Bridge.Inventory.openInventory = function(invType, data)
    ...
    elseif invType == 'shop' then
        Bridge.libs.print.error('S-Inventory does not support external shops, create shop in inventory config')
    end
end
...
Bridge.Inventory.getItemData = function(itemName)
    local info = GlobalState['npk-bridge:itemsData'][itemName]

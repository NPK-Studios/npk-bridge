...
if Config.Debug then
    Bridge.libs.print.info('[Inventory] Loaded: ak47_inventory')
end
...
Bridge.Inventory.CustomDrop = function(prefix, items, coords)
    Bridge.libs.print.error('ak47_inventory does not support CustomDrop function, please change type in config')
end
--@param playerId: number [existing player id]

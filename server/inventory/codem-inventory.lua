...
if Config.Debug then
    Bridge.libs.print.info('[Inventory] Loaded: codem-inventory')
end
...
Bridge.Inventory.CustomDrop = function(prefix, items, coords)
    Bridge.libs.print.error('CustomDrop is not supported in codem-inventory, please change type in config')
end

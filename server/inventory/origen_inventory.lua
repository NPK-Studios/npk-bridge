...
if Config.Debug then
    Bridge.libs.print.info('[Inventory] Loaded: origen_inventory')
end
...
Bridge.Inventory.CustomDrop = function(prefix, items, coords)
    Bridge.libs.print.error('CustomDrop is not supported in origen_inventory, please change type in config')
end

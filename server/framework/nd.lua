...
Bridge.Framework.getPlayerId = function(uniqueId)
    ...
    -- if you have better solution, please contact us on discord [discord.gg/npkstudios]
...
Bridge.Framework.checkPlayerLicense = function(playerId, license)
    ...
    if not licenses or type(licenses) ~= 'table' then
        Bridge.libs.print.error(('Player %s does not have any licenses or metadata is not a table.'):format(playerId))
        return false
    end

...
if Config.Debug then
    Bridge.libs.print.info('[Framework] Loaded: OX')
end
...
Bridge.Framework.removeMoney = function(playerId, account, amount)
    ...
    if account == 'black_money' then
        Bridge.libs.print.error('Black money removal is not supported in OX Framework.')
        return false
...
Bridge.Framework.addMoney = function(playerId, account, amount)
    ...
    if account == 'black_money' then
        Bridge.libs.print.error('Black money add is not supported in OX Framework.')
        return false
    elseif account == 'money' then

if (Config.Society == 'auto' and not checkResource('p_banking')) or (Config.Society ~= 'auto' and Config.Society ~= 'p_banking') then
    return
end
...
if Config.Debug then
    Bridge.libs.print.info('[Society] Loaded: p_banking')
end
